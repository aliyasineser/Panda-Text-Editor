...
public class Keywords {
    public static final String[] keywords = {   Keywords.ALIGNAS,
                                                Keywords.ALIGNOF,
                                                Keywords.AND,
                                                Keywords.AND_EQ,
                                                Keywords.ASM,
                                                Keywords.ATOMIC_CANCEL,
                                                Keywords.ATOMIC_COMMIT,
                                                Keywords.ATOMIC_NOEXCEPT,
                                                Keywords.AUTO,
                                                Keywords.BITAND,
                                                Keywords.BITOR,
                                                Keywords.BOOL,
    ...
    public static final String ATOMIC_CANCEL = "atomic_cancel";
    public static final String ATOMIC_COMMIT = "atomic_commit";
    public static final String ATOMIC_NOEXCEPT = "atomic_noexcept";
